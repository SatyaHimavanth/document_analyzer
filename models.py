...
class EarnedLeaveLetter(BaseModel):
    ...
    signature: ExtractedField = Field(
        default_factory=ExtractedField,
        alias="Signature",
        description="Signature details as extracted from the document, includes handwritten or printed text."
    )
...
class ProbationLetter(BaseModel):
    ...
    salary: ExtractedField = Field(default_factory=ExtractedField, alias="Salary", description="The salary taken by the officer during probationer per month. Format: In Indian Rupees")
...
class EarnedLeaveLetter(BaseModel):
    ...
    date: ExtractedField = Field(default_factory=ExtractedField, alias="Date", description="Document date (Format: DD-MM-YYYY)")
    no_of_days: ExtractedField = Field(default_factory=ExtractedField, alias="No_of_days", description="Number of leave days (Format: DD-MM-YYYY)")
    leave_from_date: ExtractedField = Field(default_factory=ExtractedField, alias="leave_from_date", description="Leave start date (Format: DD-MM-YYYY)")
    leave_to_date: ExtractedField = Field(default_factory=ExtractedField, alias="leave_to_date", description="Leave end date (Format: DD-MM-YYYY)")
...
class MedicalLeave(BaseModel):
    ...
    date_of_submission: ExtractedField = Field(default_factory=ExtractedField, alias="Date of Submission (Format: DD-MM-YYYY)")
